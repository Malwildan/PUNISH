...
class _PairedDevicesPageState extends State<PairedDevicesPage> {
  ...
  bool _isBluetoothConnected = false; // Add a flag for Bluetooth connection status

  @override
  void initState() {
    super.initState();
    _checkBluetoothConnection(); // Check Bluetooth connection status
    _getPairedDevices();
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: _checkBluetoothConnection, // Add a refresh button to check connection status
          ),
        ],
      ),
      body: Column(
